...
export function ChartModal(props: Props) {
  ...
  const years = Object.keys(paperYear).sort(
  ...
  const areas = Object.keys(paperArea).sort(
    (a, b) => paperArea[a] - paperArea[b]
  );
    ...
    <div>
      ...
      >
        ...
        <Alert severity="warning">
          While we try our best to maintain and update this webpage, papers
          published after 2020 Oct are not surveyed exhaustively.
          <br />
          Therefore, the statistical summary should be treated with cautions.
          <br />
          If you find an interesting ML4VIS paper, feel free to{" "}
          <a
            target="_blank"
            href={`https://github.com/ML4VIS/ML4VIS.github.io/issues/new?assignees=&labels=enhancement&template=suggest-new-ml4vis-papers.md&title=Suggest+Paper%3A+%5Bpaper+title%5D`}
          >
            create a PR in our github repo
          </a>
          !
        </Alert>
